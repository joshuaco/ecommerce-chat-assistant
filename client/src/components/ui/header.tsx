...
const categories = ['New Arrivals', 'Hot Sales 🔥', 'Best Sellers'];
            ...
            <div className='flex justify-around'>
              {categories.map((category) => (
                <a
                  href='#'
                  key={category}
                  className='text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium border border-gray-300 rounded-lg'
                >
                  {category}
                </a>
              ))}
